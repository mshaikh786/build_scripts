...
function build(){
	...
	export HOROVOD_BUILD_CUDA_CC_LIST=60,70,75
	export HOROVOD_GPU_ALLREDUCE=NCCL HOROVOD_GPU_BROADCAST=NCCL HOROVOD_GPU_ALLGATHER=NCCL
	...
	pip install --prefix=${PREFIX} horovod
}
